...
export class CustomersComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.customersService
      ...
      .subscribe(
        (res: HttpResponse<ICustomers[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: ICustomers[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
