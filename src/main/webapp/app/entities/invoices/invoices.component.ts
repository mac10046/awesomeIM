...
export class InvoicesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.invoicesService
      ...
      .subscribe(
        (res: HttpResponse<IInvoices[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInvoices(): void {
    this.eventSubscriber = this.eventManager.subscribe('invoicesListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInvoices[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
