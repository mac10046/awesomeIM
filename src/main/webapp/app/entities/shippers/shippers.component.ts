...
export class ShippersComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.shippersService
      ...
      .subscribe(
        (res: HttpResponse<IShippers[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInShippers(): void {
    this.eventSubscriber = this.eventManager.subscribe('shippersListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IShippers[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
