...
export class ShippingComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.shippingService
      ...
      .subscribe(
        (res: HttpResponse<IShipping[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IShipping[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
