...
describe('Service Tests', () => {
  describe('BusinessOpportunity Service', () => {
    let injector: TestBed;
    let service: BusinessOpportunityService;
    let httpMock: HttpTestingController;
    let elemDefault: IBusinessOpportunity;
    let expectedResult: IBusinessOpportunity | IBusinessOpportunity[] | boolean | null;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(BusinessOpportunityService);
    ...
    describe('Service methods', () => {
      ...
      it('should create a BusinessOpportunity', () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            startDate: currentDate.format(DATE_FORMAT),
        ...
        service.create(new BusinessOpportunity()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a BusinessOpportunity', () => {
