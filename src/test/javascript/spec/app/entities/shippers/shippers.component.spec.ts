...
import { ShippersComponent } from 'app/entities/shippers/shippers.component';
...
describe('Component Tests', () => {
  describe('Shippers Management Component', () => {
    let comp: ShippersComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShippersComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shippers && comp.shippers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
